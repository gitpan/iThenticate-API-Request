package iThenticate::API::Response;
...
iThenticate::API::Response - manipulate response objects for the iThenticate::API
...
This class encapsulates responses received from the iThenticate::API
...
iThenticate::API::Request, iThenticate::API::Client, RPC::XML
